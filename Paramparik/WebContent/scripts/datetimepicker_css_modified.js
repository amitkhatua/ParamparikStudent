...
var MonthYearColor = "#194B64"; //Font Color of Month and Year in Calendar header.
var WeekHeadColor = "#1F6E95"; //var WeekHeadColor="#18861B";//Background Color in Week header.
var SundayColor = "#DE6130"; //var SundayColor="#C0F64F";//Background color of Sunday.
var SaturdayColor = "#E3991D"; //Background color of Saturday.
var WeekDayColor = "#9BD1F5"; //Background color of weekdays.
var FontColor = "blue"; //color of font in Calendar day cell.
var TodayColor = "#24435D"; //var TodayColor="#FFFF33";//Background color of today.
var SelDateColor = "#C4BEB6"; //var SelDateColor = "#8DD53C";//Backgrond color of selected date in textbox.
var YrSelColor = "#cc0033"; //color of font of Year selector.
var MthSelColor = "#cc0033"; //color of font of Month selector if "MonthSelector" is "arrow".
var HoverColor = "#4681B8"; //color when mouse move over.
var DisableColor = "#E2E1E3"; //color of disabled cell.
